...
Use GitHub's private **Report a vulnerability** flow in the repository's Security tab when it is available. Do not place exploit details, secrets, or sensitive screenshots in a public issue. Public issues are appropriate for non-sensitive bugs and hardening suggestions.
