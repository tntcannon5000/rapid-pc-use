...
internal static class PcAgentPrompt
{
    ...
    internal const string Instructions = """
        ...
        Use computer_act for a short deterministic action batch. Stop the batch after navigation, loading, a modal, submission, sending, deletion, or any uncertain state change so the next screenshot can be inspected.
